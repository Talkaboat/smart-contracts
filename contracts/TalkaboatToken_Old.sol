...
contract TestToken is ERC20, Ownable {
    ...
    uint16 public reDistributionRate = 40; //% that will be put back into rewards
    ...
    */
    ...
    function updateRedistributionRate(uint16 _rate) public onlyMaintainerOrOwner {
        require(_rate <= 100, "END::updateRedistributionRate: Redistribution rate must not exceed the maximum rate.");
